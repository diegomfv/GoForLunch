            ...
            public void onNext(final PlaceById placeById) {
                ...
                if (result != null) {
                    ...
                    updateGeneralRestaurantInfoUsingPlaceId(
                            UtilsGeneral.checkToAvoidNull(result.getPlaceId()),
                            UtilsGeneral.checkToAvoidNull(result.getInternationalPhoneNumber()),
                            UtilsGeneral.checkToAvoidNull(result.getWebsite()),
                            closingTime);
        ...
        return new DisposableObserver<DistanceMatrix>() {
            ...
            public void onNext(DistanceMatrix distanceMatrix) {
                ...
                updateDistanceToRestaurantUsingPlaceId(
                        placeId,
                        UtilsGeneral.checkToAvoidNull(distanceMatrix.getRows().get(0).getElements().get(0).getDistance().getText()));
            }
            ...
            this.textSearchDisposable =
                    GoogleServiceStreams.streamFetchPlacesTextSearch(
                            ...
                            .subscribeWith(getTextSearchDisposableObserver(
                                    UtilsGeneral.getTypeAsStringAndReturnTypeAsInt(arrayOfTypes[i], arrayOfTypes)));
