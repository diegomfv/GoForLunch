package com.example.android.goforlunch.data.sqlite;//add your package name here example: package com.example.dbm;
...
/** Class used to check the elements of the SQLite Database
 * */
...
// all global variables
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		customquerytext.setHint("Enter Your Query here and Click on Submit Query ButtonListener .Results will be displayed below");
